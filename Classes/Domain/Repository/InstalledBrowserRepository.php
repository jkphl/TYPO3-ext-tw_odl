 ...
 *
 */
class InstalledBrowserRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	/**
	 * Find installed browsers by user agent string
	 * 
	...
	public function findByUserAgent($userAgent) {
		...
		$query->matching($query->equals('useragent', $userAgent));
